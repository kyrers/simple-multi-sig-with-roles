            ...
            {decodedDataObject.functionFragment &&
              decodedDataObject.functionFragment.inputs.map((element, index) => {
                if (element.type === "address") {
                  return (
                    <div key={`address-${index}`} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "left" }}>
                      <b>{element.name} :&nbsp;</b>
                ...
                if (element.type === "string") {
                  return (
                    <div key={`string-${index}`} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "left" }}>
                      <b>{element.name} :&nbsp;</b>
                      {decodedDataObject.args[index]}
                    </div>
                  );
                }
                if (element.type === "uint256") {
                  return (
                    <p key={`uint256-${index}`} style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "left" }}>
